...
from app.routers import food_items, nutrition, recipes, grocery, eating_out, spending, users, receipt_scan, ai, admin, household
...
app.include_router(receipt_scan.router, prefix="/api")
